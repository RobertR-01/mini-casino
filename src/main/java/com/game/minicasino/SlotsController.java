...
public class SlotsController {
    ...
    private List<Slots.SlotSymbol> symbolsList;
    ...
    public void initialize() {
        ...
        // initializing reels
        symbolsList = Slots.getSlotsInstance().getSymbolsList();
        ...
        firstReelPositionThreeImageView.setImage(symbolsList.get(0).getImage());
        firstReelPositionTwoImageView.setImage(symbolsList.get(1).getImage());
        firstReelPositionOneImageView.setImage(symbolsList.get(2).getImage());
    }
...
//                            System.out.println("First counter: " + firstPositionCounter);
                            firstReelPositionThreeImageView.setImage(symbolsList.get(firstPositionCounter).getImage());
...
//                            System.out.println("Second counter: " + secondPositionCounter);
                            firstReelPositionTwoImageView.setImage(symbolsList.get(secondPositionCounter).getImage());
...
//                            System.out.println("Third counter: " + thirdPositionCounter);
                            firstReelPositionOneImageView.setImage(symbolsList.get(thirdPositionCounter).getImage());
